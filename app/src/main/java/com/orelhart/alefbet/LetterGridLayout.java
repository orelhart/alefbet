...
public class LetterGridLayout extends GridLayout {
    ...
    public void setLetterViewsToGrid(Context context,AlphaBet alphabet, int cellWidth){
        ...
        for (int i = 0; i < alphabet.getAlphabetSize(); i++) {
            ...
            FrameLayout frameLayout = (FrameLayout) inflater.inflate(R.layout.letter_frame_layout, this, false);
            ...
            ((GridLayout.LayoutParams) frameLayout.getLayoutParams()).setMargins(leftMargin, topMargin, rightMargin, bottomMargin);
        }
